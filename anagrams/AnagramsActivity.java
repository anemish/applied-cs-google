...
public class AnagramsActivity extends AppCompatActivity {
            ...
            public boolean onEditorAction(TextView v, int actionId, KeyEvent event) {
                ...
                if (actionId == EditorInfo.IME_ACTION_GO) {
                    ...
                    if(anagrams.isEmpty())
                    {
                        ...
                        gameStatus.append(" Well Done! Looks like you are good with anagrams!");
                        defaultAction(null);
                    }
                    handled = true;
                }
    ...
    public boolean defaultAction(View view) {
        ...
        if (currentWord == null) {
            ...
            anagrams = (ArrayList<String>) dictionary.getAnagramsWithOneMoreLetter(currentWord);

            Log.d("Words",anagrams.toString());
            ...
            imm.showSoftInput(editText, InputMethodManager.SHOW_IMPLICIT); //http://developer.android.com/training/keyboard-input/visibility.html
        } else {
            editText.setText(currentWord);
            editText.setEnabled(false);
            fab.setImageResource(android.R.drawable.ic_media_play);

            //Show the solution to the given word:


            currentWord = null;

            resultView.append(TextUtils.join("\n", anagrams)); //iterable joined using delim
